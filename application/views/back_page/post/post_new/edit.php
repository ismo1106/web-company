<div class="main-content">
    ...
    <form role="form" method="post" class="form-horizontal form-groups-bordered validate" action="<?php echo site_url('back/post/updatePost');?>">
        ...
        <div class="form-group" >
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="inputTitlePost" name="txtTitlePost" placeholder="Input Title" data-validate="required"
                       data-message-required="Please insert this field!"  value="<?php echo $row->title_post;?>">
                <input type="hidden" class="form-control" id="inputIdPost" name="txtidPost" value="<?php echo $row->id_post;?>">
            </div>
        </div>
        ...
        <div class="form-group" >
            <div class="col-sm-9">
                <textarea id="inputPostValue" name="txtPostValue" class="form-control ckeditor"><?php echo $row->post;?></textarea>
            </div>
            ...
            <div class="col-sm-3">
                ...
                <select id="inputCategory" name="selCategory" class="form-control select" >
                    ...
                    foreach ($_selectCategory as $rowCat):
                        if($row->id_category == $rowCat->id_category){
                ...
                <br/>
                <label for="txtNickname" class="control-label">Updated by</label>

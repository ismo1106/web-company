        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-dark" data-collapsed="1">
                ...
                <div class="panel-body">
                    <form role="form" class="form-horizontal form-groups-bordered validate" method="POST" action="<?php echo site_url('back/post/saveBlogCategory'); ?>">
    ...
    jQuery(function($) {
        $("#table-category").on("click", ".delete", function() {
            ...
            bootbox.confirm("Are you sure?", function(result) {
                if(result) {
                    window.location='<?php echo site_url();?>back/post/deleteBlogCategory/'+id;
                }
            });
        });
    });
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function($) {
        ...
        tableContainer.on("click", ".edit", function() {
            ...
            var id = $(this).data('id');
            $.ajax({
                url:"<?php echo site_url('back/post/viewModalEditCategory');?>",
                type:"POST",
                data:"kode="+id,
                datatype:"json",
                cache:false,

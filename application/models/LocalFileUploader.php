    ...
    public function moveFile($temp_location)
    {
        ...
        if (isset($temp_location['tmp_name']) &&
            ...
            if (!is_dir(self::IMAGE_UPLOAD_DIR) ||
                ...
                if (!is_writable(self::IMAGE_UPLOAD_DIR) || FALSE === @mkdir(self::IMAGE_UPLOAD_DIR, null , TRUE)) {
                    throw new Exception('Error: File permission issue, please consult your system administrator');
                }
            }

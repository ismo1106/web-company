<form role="form" method="post" class="form-horizontal form-groups-bordered validate" action="<?php echo site_url('back/SetupWidget/saveSlider'); ?>" enctype="multipart/form-data" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="radio" value="1" name="radImgPotition" required="" checked>
            <label for="icon1" class="control-label">Right</label>
            <input type="radio" value="0" name="radImgPotition">

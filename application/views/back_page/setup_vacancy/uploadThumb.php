    ...
    <div class="panel panel-dark" data-collapsed="0">
        <div class="panel-heading">
            <div class="panel-title">
                Upload Thumbnail Vacancy, <strong><?php echo $row->title_jobs;?></strong>
            </div>
        </div>
        <div class="panel-body">
            <form role="form" method="post" class="form-horizontal form-groups-bordered validate" style="padding-top: 30px;"
                  action="<?php echo site_url('back/SetupVacancy/uploadThumbVacancy'); ?>" enctype="multipart/form-data" >
                <input name="txtIdVacancy" value="<?php echo $row->id_vacancy;?>" type="hidden">
                ...
                <div class="form-group text-center">
                    ...
                    <a href="<?php echo base_url('back/SetupVacancy/allVacancy');?>" class="btn btn-blue"> 

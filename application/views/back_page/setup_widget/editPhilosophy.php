<form role="form" method="post" class="form-horizontal form-groups-bordered validate" action="<?php echo site_url('back/SetupWidget/editPhilosophy'); ?>">
    ...
    <div class="form-group">
        ...
        <label for="txtNickname" class="col-sm-2 control-label">Updates by</label>
        <div class="col-sm-4">

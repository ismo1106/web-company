<form role="form" class="form-horizontal form-groups-bordered validate" method="POST" action="<?php echo site_url('back/SetupVacancy/editCategory'); ?>">
    <?php foreach ($_getCategory as $row): ?>

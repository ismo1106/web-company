...
<div class="main-content">
    ...
    <form role="form" method="post" class="form-horizontal form-groups-bordered validate" action="<?php echo site_url('back/setupProduct/saveProduct'); ?>" enctype="multipart/form-data" >
        <div class="form-group" >
            <label for="inputProductName" class="col-sm-2 control-label">Product Name</label>
            <div class="col-sm-7">
                <input type="text" class="form-control" id="inputProductName" name="txtProductName" placeholder="Input Product Name" 
        ...
        <div class="form-group" >
            <div class="col-sm-9">
                <textarea id="inputDescription" name="txtDescription" class="form-control ckeditor"></textarea>
            </div>
            ...
            <div class="col-sm-3">
                ...
                <br/>
                <button class="btn btn-block btn-primary" type="submit"><i class="fa fa-save"></i>&nbsp; Save &amp; Continue</button>
            </div>
        </div>
